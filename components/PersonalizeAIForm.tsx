...
export default function PersonalizedAIForm({ isOpen, onClose }: PersonalizedAIFormProps) {
        ...
        <div>
            <AnimatePresence>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <Label htmlFor="name" className="text-sm font-medium text-white dark:text-black">Name</Label>
                                        <Input
                                            id="name"
                                            name="name"
                                            value={formData.name}
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="age" className="text-sm font-medium text-white dark:text-black">Age</Label>
                                        <Input
                                            id="age"
                                            name="age"
                                            type="number"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="occupation" className="text-sm font-medium text-white dark:text-black">Occupation</Label>
              ...
              placeholder:text-gray-100 dark:placeholder:text-gray-600"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="background" className="text-sm font-medium text-white dark:text-black">Your Background</Label>
                                    <Textarea
                                        id="background"
                                        name="background"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="interests" className="text-sm font-medium text-white dark:text-black">Interests</Label>
                                    <Textarea
                                        id="interests"
                                        name="interests"
                                ...
                                <div className="space-y-2">
                                    <Label className="text-sm font-medium text-white dark:text-black">Preferred Learning Style</Label>
                                    <RadioGroup
                                        name="learningStyle"
                                    ...
                                    >
                                        {["Visual", "Auditory", "Reading/Writing", "Kinesthetic"].map((style) => (
                                            <div key={style} className="flex items-center space-x-2">
                                                <RadioGroupItem value={style.toLowerCase()} id={style.toLowerCase()} className="text-white dark:text-black bg-gray-800 dark:bg-white"/>
                                                <Label htmlFor={style.toLowerCase()} className="text-white dark:text-black">{style}</Label>
                                            </div>
                                        ))}
                                    </RadioGroup>
                                </div>
...
>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="goals" className="text-sm font-medium text-white dark:text-black">Your Goals</Label>
                                    <Textarea
                                        id="goals"
                                        name="goals"
